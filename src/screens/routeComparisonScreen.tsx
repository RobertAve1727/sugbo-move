        ...
        <section className="grid gap-4 mb-6">
          <div className="bg-[#04162e] text-white p-8 rounded-[2rem] shadow-xl relative overflow-hidden">
            ...
            <p className="text-sm opacity-70 mb-6 max-w-[240px]">
              Optimized for cost efficiency and low traffic density through
              Mandaue.
            </p>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-white p-6 rounded-3xl border-l-[6px] border-yellow-400 shadow-sm">
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="flex gap-2">
                <span className="bg-yellow-50 text-yellow-700 px-3 py-1 rounded-full text-[10px] font-bold uppercase">
                  Moderate Traffic
                </span>
            ...
            <div className="grid grid-cols-3 gap-4 mb-6 text-gray-400 uppercase text-[10px] font-bold tracking-widest">
              <div>
                Distance{" "}
                <p className="text-lg text-black lowercase mt-1">12.4 km</p>
              </div>
              <div>
                Est. Time{" "}
                <p className="text-lg text-black lowercase mt-1">22 min</p>
              </div>
              <div>
                Fuel Cost{" "}
                <p className="text-lg text-black lowercase mt-1">₱0</p>
              </div>
            </div>
          ...
          <div className="bg-white p-6 rounded-3xl border-l-[6px] border-green-400 shadow-md ring-1 ring-black/5">
            ...
            <div className="grid grid-cols-3 gap-4 mb-6 text-gray-400 uppercase text-[10px] font-bold tracking-widest">
              <div>
                Distance{" "}
                <p className="text-lg text-black lowercase mt-1">14.8 km</p>
              </div>
              <div>
                Est. Time{" "}
                <p className="text-2xl text-green-500 font-bold lowercase">
                  28 min
                </p>
              </div>
              <div>
          ...
          <div className="bg-white p-6 rounded-3xl border-l-[6px] border-red-500 shadow-sm opacity-80">
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="flex gap-2">
                <span className="bg-red-50 text-red-600 px-3 py-1 rounded-full text-[10px] font-bold uppercase">
                  Heavy Traffic
                </span>
                <span className="bg-red-50 text-red-400 px-3 py-1 rounded-full text-[10px] font-bold uppercase">
                  +5% CO2
                </span>
              </div>
            </div>
            <div className="grid grid-cols-3 gap-4 mb-6 text-gray-400 uppercase text-[10px] font-bold tracking-widest">
              <div>
                Distance{" "}
                <p className="text-lg text-black lowercase mt-1">11.2 km</p>
              </div>
              <div>
                Est. Time{" "}
                <p className="text-lg text-black lowercase mt-1">45 min</p>
              </div>
              <div>
                Fuel Cost{" "}
                <p className="text-lg text-black lowercase mt-1">₱0</p>
